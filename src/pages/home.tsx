...
import grandyBefore from "@assets/image_1781820969603.png";
import grandyAfter from "@assets/image_1781820983378.png";
...
export const ORANGE = "#F95500";
export const DARK = "#0E0C0A";
export const CREAM = "#F2EAE0";
...
export function openCaseStudy(index: number) {
...
export const brands: Brand[] = [
  {
    name: "Taza Chocolate",
    category: "Paid Media · Email · SMS · Social",
    span: "full",
    bg: tazaSpring,
    caseStudy: {
  ...
  {
    name: "Reuzel",
    category: "Paid Media · Email · SMS",
    bg: reuzelReel,
    caseStudy: {
      subtitle: "Premium men's grooming · Partnership since August 2023",
      tagline:
        "Took over paid media and rebuilt email from the ground up, driving a 12% ROAS improvement and 51% YoY email revenue growth in the first full year.",
      heroStat: {
        value: "3.92x",
        label: "Blended ROAS, 2024",
        context: "Across Google, Meta, and Microsoft, with spend scaled 10x year over year",
      },
      challenge:
      ...
      approach:
        "Took over 100% of paid media in August 2023 across Google, Meta, and Microsoft. Rebuilt the email program from the ground up with new segmentation and a campaign calendar tied to tentpole holidays, product collections and limited-edition drops.",
      result:
      ...
      results: [
        ...
        { value: "+23%", label: "Total revenue YoY", context: "Across all channels, 2024" },
        { value: "12.1x", label: "Meta revenue growth", context: "Fastest-scaling paid channel" },
      ],
    },
  },
  {
  ...
  {
    name: "Born Simple",
    category: "Influencer · Social · Retail",
    bg: bornSimpleFamily,
    caseStudy: {
      subtitle: "Ready-to-eat protein bowls and mac & cheese · Walmart distribution",
      tagline:
        "Broke through wellness influencer fatigue by shifting paid spend to adjacent creator categories like comedians, musicians, and van life, driving 782K views with 555K engagements.",
      heroStat: {
        value: "782K",
        label: "Views across three creators",
        context: "555K total engagements through a single category-shift influencer campaign",
      },
      challenge:
        "Born Simple needed to break through in a wellness influencer space that had become oversaturated, with audiences showing fatigue from traditional paid partnerships. Standard playbooks weren't going to land.",
      approach:
        "Shifted paid influencer spend away from wellness creators to adjacent categories like comedians, musicians, and van life that naturally reflected the brand's convenience and authenticity pillars. Wellness influencers stayed engaged through in-kind sends.",
      result:
        "Significantly higher engagement, view counts, and follower growth compared to traditional wellness partnerships. Multiple social accounts grew past 1K followers in under a year through humor-led, trend-driven content.",
      scope: ["Social", "Influencer", "Retail Support"],
      results: [
        { value: "485K", label: "Views, single creator", context: "@mariomirante, comedian" },
        { value: "462K", label: "Engagements, single post", context: "@gabepietrafesa, musician" },
        { value: "1K+", label: "Followers in <1 year", context: "Multiple owned channels" },
        { value: "BOGO", label: "Walmart national push", context: "Paid media + on-platform" },
      ],
    },
  },
  {
    name: "Honey Mama's",
    category: "Paid Media · Retail Launch",
    bg: honeyMamas,
    caseStudy: {
      subtitle: "Refrigerated cacao-honey bars · Target national launch, 2024",
      tagline:
        "Launched Honey Mama's into Target nationally with a BOGO rebate campaign that drove 20K+ trial opt-ins, a 23% opt-in-to-purchase rate, and $1.29 cost-per-trial.",
      heroStat: {
        value: "23%",
        label: "Opt-in to purchase rate",
        context: "4,783 validated in-store purchases from 20,845 campaign opt-ins",
      },
      challenge:
        "Honey Mama's was entering Target nationally and needed a launch strategy that drove trial at shelf, not just brand awareness. With a refrigerated, premium-priced product, getting first purchase was everything.",
      approach:
        "Built and ran a BOGO rebate campaign on Facebook and Instagram targeted to the Target shopping audience. Captured email and marketing consent at opt-in, then drove consumers to the shelf with a validated purchase redemption loop.",
      result:
        "20,845 opt-ins, 23% converted to a validated in-store purchase, and $1.29 cost per trial, well below typical CPG trial benchmarks. 66% of opt-ins also consented to marketing, building a first-party data asset alongside the trial volume.",
      scope: ["Paid Media", "Retail Support", "Rebate Campaign"],
      results: [
        { value: "20.8K", label: "Trial opt-ins", context: "Facebook/Instagram campaign" },
        { value: "$1.29", label: "Cost per trial", context: "$6,186 ad spend · 4,783 validated purchases" },
        { value: "66%", label: "Marketing consent rate", context: "13,704 consents from 20,845 opt-ins" },
        { value: "2.9x", label: "Instacart ROAS", context: "Target launch push" },
      ],
    },
  },
  {
    ...
    caseStudy: {
      ...
      tagline:
        "Built Taza's SMS program from zero to 34.7x lifetime ROI, growing every year since launch, then replicated the playbook at Reuzel, proof of repeatability across different brands at different stages.",
      heroStat: {
        value: "34.7x",
        label: "Program ROI since 2022",
        context: "Automations drive 56% of revenue from just 15% of sends. Built from zero subscribers",
      },
      challenge:
        "Brands with healthy email lists often hesitate to launch SMS, worried they'll cannibalize their best customers instead of finding incremental revenue. The right SMS program needs to supplement, not replace.",
      approach:
        "SMS-exclusive offers and flash sales, restrained brand-building content, and automated flows for welcome, abandoned cart, and post-purchase. Disciplined send cadence to keep subscribers engaged without burning the list.",
      result:
        "A compounding revenue channel that grows year over year. Taza's program reached 34.7x lifetime ROI, growing every year since launch. Reuzel's first full year delivered 35% YoY growth, proof the playbook replicates.",
      scope: ["SMS", "Retention", "Automation"],
      results: [
        { value: "$42.92", label: "Subscriber LTV", context: "Taza: program health" },
        { value: "74%", label: "D30 retention", context: "Taza subscriber base" },
        { value: "+35%", label: "SMS revenue YoY", context: "Reuzel: first full year" },
        { value: "$4.32", label: "Per welcome send", context: "Reuzel welcome flow" },
      ],
    },
  },
];
...
const tickerItems = [
  { label: "20+ CPG Brands" },
  { label: "15+ Major Retailers Nationwide" },
  { label: "100% CPG Focused" },
] as const;
...
const stats: { value: string; label: string; context?: string }[] = [
  ...
  { value: "46%", label: "Returning Customer Rate", context: "Taza, +14% YoY" },
      ...
      >
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-3 items-center">
          ...
          <div className="hidden md:flex items-center justify-end gap-8">
            ...
            <button
              onClick={() => openContact()}
              className="text-xs font-bold uppercase tracking-[0.2em] px-4 py-2 border transition-colors cursor-pointer rounded-full"
              style={{ color: ctaHovered ? "#fff" : ORANGE, borderColor: ORANGE, background: ctaHovered ? ORANGE : "transparent" }}
...
const retailerLogos: Array<{ src?: string; alt: string; filter?: string; text?: string }> = [
          ...
          {logos.map((logo, i) => (
            ...
            >
              {logo.src ? (
                ...
                <span style={{ color: "#fff", fontWeight: 900, fontSize: "clamp(1.1rem, 2vw, 1.6rem)", letterSpacing: "0.12em", textTransform: "uppercase", opacity: 0.6 }}>
                  {logo.text}
                </span>
              )}
            </div>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <motion.h2
          className="font-black text-white leading-[0.88] tracking-tight mb-16"
        ...
        >
          {/* Sub-heading + intro */}
          <div className="mb-12">
            <p className="text-sm font-black uppercase tracking-[0.22em] mb-4" style={{ color: ORANGE }}>
              Smaller on purpose.
            </p>
            <p className="text-white/50 text-xl leading-relaxed max-w-3xl">
              The big-agency model wasn't built for emerging CPG. You don't need 12 layers of account management. You need senior people who know your category, ship work, and answer their email.
            </p>
          </div>

          {/* Three pillars */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px mb-px" style={{ background: "rgba(255,255,255,0.08)" }}>
            {[
              {
                title: "Senior team, no pass-off",
                body: "The people who pitched you are the people doing the work. No account exec layer between you and the strategist running your campaigns.",
              },
              {
                title: "CPG-native, not CPG-curious",
                body: "We've worked exclusively in natural products and CPG for years. We know buyer cycles, retail provisional scopes, and how to make a brand stand out on shelf.",
              },
              {
                title: "Honest about diminishing returns",
                body: "We'll tell you when to stop spending. Most agencies have a structural incentive to recommend more. We focus on blended ROAS and protecting your dollars.",
              },
            ].map((p) => (
              <div key={p.title} className="p-8" style={{ background: DARK }}>
                <h4 className="font-black text-white text-base mb-3">{p.title}</h4>
          ...
          {/* Comparison table */}
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-px" style={{ background: "rgba(255,255,255,0.08)" }}>
            <div className="p-8" style={{ background: DARK }}>
              <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-white/30 mb-6">Typical Agency</p>
              {["Junior staff on the daily work", "Generalist across every vertical", "Reporting that's hard to parse", "Incentivized to grow spend"].map((item) => (
                <div key={item} className="flex items-start gap-3 mb-4">
                  <span className="mt-0.5 text-white/25 text-sm leading-none">✕</span>
                  <span className="text-white/40 text-sm leading-snug">{item}</span>
                </div>
              ))}
            </div>
            <div className="p-8" style={{ background: DARK }}>
              <p className="text-[10px] font-bold uppercase tracking-[0.28em] mb-6" style={{ color: ORANGE }}>Little Pilot</p>
              {["Senior team, end to end", "100% CPG specialty", "Clear KPIs, honest reporting", "Incentivized to grow profitably"].map((item) => (
                <div key={item} className="flex items-start gap-3 mb-4">
                  <span className="mt-0.5 text-sm leading-none" style={{ color: ORANGE }}>✓</span>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <ScrollReveal className="mb-20">
          <h2
            ...
            style={{ fontSize: "clamp(1.8rem, 4vw, 3.5rem)", color: "#fff" }}
          >
    ...
    <AnimatePresence>
      {brand && cs && (
        ...
        >
          <div
            className="absolute inset-0"
            style={{ background: "rgba(14,12,10,0.78)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)" }}
          />
          <motion.div
            ref={panelRef}
          ...
          >
            ...
            <div className="p-6 md:p-10">
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-3">
                    <div className="overflow-hidden" style={{ borderRadius: 8 }}>
                      <div className="relative aspect-[4/3]" style={{ background: DARK }}>
                        <img src={brand.bgBefore} alt="Before" className="absolute inset-0 w-full h-full object-cover" />
                        <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(14,12,10,0.65) 0%, rgba(14,12,10,0.0) 60%)" }} />
                        <span className="absolute bottom-3 left-3 text-[10px] font-black uppercase tracking-[0.28em] text-white/70">Before</span>
                      </div>
                    </div>
                    <div className="overflow-hidden" style={{ borderRadius: 8 }}>
                      <div className="relative aspect-[4/3]" style={{ background: DARK }}>
                        <img src={brand.bg} alt="After" className="absolute inset-0 w-full h-full object-cover" />
                        <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(14,12,10,0.65) 0%, rgba(14,12,10,0.0) 60%)" }} />
                        <span className="absolute bottom-3 left-3 text-[10px] font-black uppercase tracking-[0.28em]" style={{ color: ORANGE }}>After</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <button
                ...
                style={{ background: ORANGE, color: "#fff", border: "none", borderRadius: 9999 }}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2
          className="font-black text-white leading-[0.85] tracking-tight mb-12"
        ...
        <div className="flex flex-col sm:flex-row items-start gap-8">
          ...
          <a
            ...
            className="self-center inline-flex items-center gap-3 text-sm font-bold uppercase tracking-widest px-8 py-4 transition-colors"
            style={{ background: "transparent", color: CREAM, border: `1px solid rgba(242,234,224,0.3)`, borderRadius: 9999 }}
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = CREAM; }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(242,234,224,0.3)"; }}
          >
            Book a Call →
          </a>
        </div>
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <div
            className="absolute inset-0"
            style={{ background: "rgba(8,7,6,0.78)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)" }}
            onClick={close}
